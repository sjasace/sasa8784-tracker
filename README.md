...
The functionality is definitely what needs to be improved on here, the development of the popus should have been first and foremost what was completed before the other elements. 

I work on a basis of developing something of the appearance and then making it work, however, this mindset was my downfall. I felt as though I knew what to do, what code to use and how to make it work, however, this did not transform as hoped. I did attempt to at least get all the features that were needed on that first popup to show that the skill was there, despite the execution being illusive. 
...
Within the web app design assessment, it was noted that the file upload feature would be difficult to implement, and yes it very much was. So I put this idea forth for a futher extension of the program, so that users can know their meals by more than the name but by the visual features. This will also be a feature that will make the meal history an easier feat to understand and be used by users, as most are visual learners, especially in our digital age. The identification of meals will be a breeze. 
